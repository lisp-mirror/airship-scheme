...
(5am:test numeric-syntax
  ...
  (is (eql (read-scheme* "3+2i")
           #C(3 2)))
  ;; TODO: There will probably have to be a helper function to handle
  ;; testing this syntax.
  #+(or) (is (eql (read-scheme* "4@5")))
  #+(or) (is (eql (read-scheme* "-3.0@+4e3")))
  #+(or) (is (eql (read-scheme* "4@+inf.0")))
  #+(or) (is (eql (read-scheme* "-7@-nan.0")))
  #+(or) (is (eql (read-scheme* "+inf.0f0@111")))
  #+(or) (is (eql (read-scheme* "+inf.0@-3")))
  #+(or) (is (eql (read-scheme* "+nan.0@42")))
  #+(or) (is (eql (read-scheme* "+inf.0@-inf.0")))
  #+(or) (is (eql (read-scheme* "-nan.0@+nan.0"))))
