...
(5am:test arithmetic
  ...
  (is (eql (r7rs::abs #'identity -479678) 479678))
  (is (eql (r7rs::abs #'identity 742) 742))
  (is (eql (r7rs::abs #'identity -674.578d0) 674.578d0))
  (is (eql (r7rs::abs #'identity 976.798d0) 976.798d0))
